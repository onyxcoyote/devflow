...
def make_plan_node(model, compact_retry_model, logger):
    def create_plan(state: PlanningState) -> dict:
        ...
        prompt = (
            ...
            "Respect human-input authority: authoritative_requirement defines desired behavior; "
            "repository_hint and documentation_hint only direct investigation; "
            "implementation_hypothesis is a proposal to evaluate; unverified_fact requires "
            "repository evidence. Never convert a hint or hypothesis into verified current code.\n"
